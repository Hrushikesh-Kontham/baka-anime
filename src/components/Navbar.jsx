...
function Navbar({ sidebarOpen, setSidebarOpen }) {
  ...
  return (
    <nav style={{
      ...
      {!isMobile && (
        <form onSubmit={handleSearch} style={{ flex: 1, maxWidth: '520px', display: 'flex', backgroundColor: '#1a1a1a', border: '1px solid #2a2a2a', borderRadius: '8px', overflow: 'hidden' }}>
          <input
            type="text"
            value={query}
          ...
          />
          <button type="submit" style={{ backgroundColor: '#e50914', color: '#fff', border: 'none', padding: '10px 18px', cursor: 'pointer', fontWeight: '600', fontSize: '13px' }}>
            Search
          </button>
        </form>
      )}
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexShrink: 0 }}>
        ...
        <a href="/watchList" style={{ display: 'flex', alignItems: 'center', gap: '6px', color: '#aaa', textDecoration: 'none', padding: '8px 12px', borderRadius: '8px', fontSize: '13px', fontWeight: '500', border: '1px solid #2a2a2a' }}
